...
pickle.dump(gt_by_cls, open('gt_dump_result.pc', 'wb'), pickle.HIGHEST_PROTOCOL)
pickle.dump(plain_detections, open('pred_dump_result.pc', 'wb'), pickle.HIGHEST_PROTOCOL)
